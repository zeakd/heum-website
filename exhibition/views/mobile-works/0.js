          ...
          <p>
            <KoText
              css={css`
                font-size: 10px;
              `}
            >조현서 작가는 이런 현대인의 편집되는 자아를 ‘Peter Piper’라는 가상의 인물에 빗대어 모두의 이야기임을 전달하고자 하였다. 편집되는 자아는 온라인이라는 가상 공간에서의 정체성이지만, 그것이 결코 가상에 그치지 않고 결국 현실에 닿음을 디지털 아트와 설치물을 통해 다양한 각도로 조명한다.</KoText>
          </p>
        </>
      }
      right={
